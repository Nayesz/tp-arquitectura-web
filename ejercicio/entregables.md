...
Modalidad: Individual Tiempo de entrega: sin tiempo Objetivo: Que el estudiante documente formalmente los endpoints de la API de su backend elegido, aplicando el vocabulario de rutas, verbos y status codes desarrollado en el módulo. Puntaje o calificación: 0-10 puntos Formato de entrega: ver entregables.

#### Entregables

- [X] Documento exportado (PDF o formato equivalente) con la descripción del backend y la documentación completa de la API.
- [X] Opcionalmente, el mismo contenido integrado en el README del repositorio del backend (no reemplaza el documento exportado, lo complementa).